...
var _page0 = () => import("./chunks/node_C9H1GGj_.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/status_fK43lkda.mjs");
var _page2 = () => import("./chunks/index_8Ym3srsj.mjs");
...
var _manifest = deserializeManifest({"rootDir":"file:///home/ubuntu/status-page/","cacheDir":"file:///home/ubuntu/status-page/node_modules/.astro/","outDir":"file:///home/ubuntu/status-page/dist/","srcDir":"file:///home/ubuntu/status-page/src/","publicDir":"file:///home/ubuntu/status-page/public/","buildClientDir":"file:///home/ubuntu/status-page/dist/client/","buildServerDir":"file:///home/ubuntu/status-page/dist/server/","adapterName":"@astrojs/node","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/node.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/status","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/status\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"status","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/status.ts","pathname":"/api/status","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap\";[data-astro-cid-ju4pidww]{box-sizing:border-box;margin:0;padding:0}body{color:#fff;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;background:linear-gradient(135deg,#1e3c72 0%,#2a5298 100%);min-height:100vh;font-family:Inter,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;line-height:1.6}main[data-astro-cid-ju4pidww]{min-height:100vh;padding:2rem 1rem}:root{--glass-bg:#ffffff14;--glass-border:#ffffff26;--text-primary:#fff;--text-secondary:#ffffffb3;--text-muted:#ffffff80;--status-green:#4ade80;--status-yellow:#facc15;--status-red:#f87171;--status-blue:#60a5fa}body:before{content:\"\";z-index:-2;background:linear-gradient(135deg,#1e3c72 0%,#2a5298 50%,#1e3c72 100%) 0 0/200% 200%;width:100%;height:100%;animation:20s infinite gradientShift;position:fixed;top:0;left:0}@keyframes gradientShift{0%,to{background-position:0%}50%{background-position:100%}}body:after{content:\"\";z-index:-1;background:radial-gradient(circle,#60a5fa26 0%,#0000 70%);border-radius:50%;width:600px;height:600px;animation:25s ease-in-out infinite float;position:fixed;top:-300px;right:-200px}@keyframes float{0%,to{opacity:.6;transform:translate(0)scale(1)}50%{opacity:.8;transform:translate(-60px,40px)scale(1.1)}}[data-astro-cid-ju4pidww]::-webkit-scrollbar{width:8px}[data-astro-cid-ju4pidww]::-webkit-scrollbar-track{background:#ffffff0d}[data-astro-cid-ju4pidww]::-webkit-scrollbar-thumb{background:#fff3;border-radius:4px}[data-astro-cid-ju4pidww]::-webkit-scrollbar-thumb:hover{background:#ffffff4d}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/ubuntu/status-page/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.CJEtCnin.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_DS5V7T-N.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","/home/ubuntu/status-page/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/node/server.js":"entry.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_8Ym3srsj.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/node@_@js":"chunks/node_C9H1GGj_.mjs","/home/ubuntu/status-page/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_D4PdXgZ3.mjs","\u0000virtual:astro:page:src/pages/api/status@_@ts":"chunks/status_fK43lkda.mjs","/home/ubuntu/status-page/src/components/status/StatusPage.tsx":"_astro/StatusPage.KvE0smAo.js","@astrojs/react/client.js":"_astro/client.DOfRi1xi.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/favicon.ico","/favicon.svg","/_astro/StatusPage.KvE0smAo.js","/_astro/client.DOfRi1xi.js","/_astro/react-dom.4QWisnGY.js"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"fZkD+6moDq6l2My5SSArcclOoKuYPqHZSde1PoXgrtU=","sessionConfig":{"driver":"unstorage/drivers/fs-lite","options":{"base":"/home/ubuntu/status-page/node_modules/.astro/sessions"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			PORT: "3001",
			_: "/home/ubuntu/.npm-global/bin/npm"
		})?.PROD) return {
...
var mode = "standalone";
var client = "file:///home/ubuntu/status-page/dist/client/";
var server = "file:///home/ubuntu/status-page/dist/server/";
var port = 4321;
